...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    console.log("Received message:", request); // Log the received message
    if (request.message=== 'Translated') {
        console.log("SHOW_TRANSLATED_POPUP triggered"); // Log for SHOW_TRANSLATED_POPUP
        showTranslatedPopup();
    }
    else if (request.type === 'SHOW_POPUP') {
        console.log("SHOW_POPUP triggered"); // Log for SHOW_POPUP
...
function showTranslatedPopup() {
    ...
    // Set the message text for the popup
    const messageText = document.createTextNode('Translated and copied to clipboard.');
